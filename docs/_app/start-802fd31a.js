...
var X = (a, e, t) =>
    e in a
      ? ae(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (a[e] = t),
  v = (a, e) => {
...
var F = (a, e) => {
  ...
  if (a != null && q)
    for (var r of q(a)) e.indexOf(r) < 0 && Y.call(a, r) && (t[r] = a[r]);
  return t;
};
import {
  S as ce,
  ...
  return (
    i && (e = new i(o(a))),
    {
      ...
      p(s, n) {
        const c = n & 2 ? C(l, [j(s[1] || {})]) : {};
        if (
          (n & 525 && (c.$$scope = { dirty: n, ctx: s }), i !== (i = s[0][0]))
        ) {
          if (e) {
            P();
            const f = e;
  ...
  return (
    i && (e = new i(o(a))),
    {
      ...
      p(s, n) {
        const c = n & 4 ? C(l, [j(s[2] || {})]) : {};
        if (
          (n & 521 && (c.$$scope = { dirty: n, ctx: s }), i !== (i = s[0][1]))
        ) {
          if (e) {
            P();
            const f = e;
...
function re(a) {
  return a instanceof SVGAElement
    ? new URL(a.href.baseVal, document.baseURI)
    : new URL(a.href);
}
class Ie {
  constructor({ base: e, routes: t, trailing_slash: r, renderer: l }) {
    ...
    (this.base = e),
      ...
      (this.current_history_index =
        (o = (i = history.state) == null ? void 0 : i["sveltekit:index"]) !=
        null
          ? o
          : 0),
      this.current_history_index === 0 &&
        history.replaceState(
          B(v({}, history.state), { "sveltekit:index": 0 }),
          "",
          location.href
        ),
  ...
  async _navigate({
    ...
    if (
      ...
      (i.state["sveltekit:index"] = this.current_history_index += d),
        history[i.replaceState ? "replaceState" : "pushState"](
          i.state,
          "",
          h.url
        );
    ...
    if (
      (await this.renderer.handle_navigation(h, l, !1, {
        scroll: t,
        keepfocus: r,
      }),
      this.navigating--,
...
function ie(a) {
  return a instanceof Error || (a && a.name && a.message)
    ? a
  ...
  async _load({ route: e, info: { url: t, path: r } }, l) {
    ...
    e: for (let _ = 0; _ < s.length; _ += 1) {
      ...
      try {
        ...
        if (
          ...
          if (
            ...
            if (
              (p.loaded.error && ((A = p.loaded.status), (E = p.loaded.error)),
              p.loaded.redirect)
            )
              return {
      ...
      if (E) {
        ...
        p && p.loaded && p.loaded.stuff && (d = v(v({}, d), p.loaded.stuff)),
          u.push(p);
    }
...
async function Je({
  ...
  const s = new Be({ Root: Ne, fallback: Ce, target: e, session: t }),
    n = r
      ? new Ie({ base: a.base, routes: Te, trailing_slash: i, renderer: s })
      : null;
  xe(a),
    o && (await s.start(o)),
    n &&
      (l && n.goto(location.href, { replaceState: !0 }, []),
      n.init_listeners()),
