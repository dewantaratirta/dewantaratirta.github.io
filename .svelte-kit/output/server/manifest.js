export const manifest = {
	...
	_: {
		entry: {"file":"_app/immutable/start-8d6de97d.js","imports":["_app/immutable/start-8d6de97d.js","_app/immutable/chunks/preload-helper-aa6bc0ce.js","_app/immutable/chunks/index-4ed68ad2.js","_app/immutable/chunks/singletons-281056cf.js","_app/immutable/chunks/index-990a9927.js"],"stylesheets":[]},
		nodes: [
			() => import('./nodes/0.js'),
			() => import('./nodes/1.js'),
			() => import('./nodes/2.js')
		...
		routes: [
			...
			{
				id: "api/all_post",
				pattern: /^\/api\/all_post\/?$/,
				names: [],
				types: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/all_post/_server.js')
			}
		],
		matchers: async () => {
